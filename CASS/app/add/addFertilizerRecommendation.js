...
angular.module('cassApp.addFertilizerRecommendation', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/addFertilizerRecommendation', {
            templateUrl: 'add/addFertilizerRecommendation.html',
            controller: 'addFertilizerRecommendationCtrl'
        });
}])
    .controller('addFertilizerRecommendationCtrl', ['$scope', 'HttpDataService', '$location', function ($scope, HttpDataService, $location) {
        var toFetchSTandYT = {};
...
//            console.log(viewYieldTarget);
        ...
        $scope.addSoilTstRslt = function (addFertRecommMap) {
            ...
            if (toFetchSTandYT.isStateIdSelected && toFetchSTandYT.isSFertTypeIdSelected && toFetchSTandYT.isDistrictIdSelected && toFetchSTandYT.isCropIdSelected) {
                ...
                HttpDataService.addFertRecomm(addFertRecommCriteriaMap).then(function (addSoilTestResultResponse) {
